...
export default function Subscriptions() {
  ...
  const handleSubscribe = async () => {
    ...
    console.log(stripe); 
    try {
      const response = await axios.post('https://jumpinghorses-examproject-1.onrender.com/api/create-checkout-session', {
  ...
  const handleCancelSubscription = async () => {
    try {
      const response = await axios.post('https://jumpinghorses-examproject-1.onrender.com/api/cancel-subscription', {
